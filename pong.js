...
const ball = {
    ...
    radius : Math.sqrt((0.0981*(canvas.height * canvas.width)/100)*(1/Math.PI)),
    color : "#F2937D",
...
function render(){
    ...
    drawRect(paddleA.x, paddleA.y, paddleA.width, paddleA.height, paddleA.color);
    drawRect(paddleB.x, paddleB.y, paddleB.width, paddleB.height, paddleB.color);
    Drawnet();
...
function recalculate(){
    ...
    ball.radius = Math.sqrt((0.0981*(canvas.height * canvas.width)/100)*(1/Math.PI));
